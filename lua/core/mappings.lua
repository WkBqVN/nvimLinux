...
-- DAP
maps.n["gc"] = {"<cmd>lua require'jdtls'.organize_imports()<cr>",desc = "jdtls imports"}
maps.n["gq"] = {"<cmd>lua require'dap'.continue()<cr>",desc = "start or continue dap"}
maps.n["g["] = {"<cmd>lua require'dap'.toggle_breakpoint()<cr>",desc = "toogle breakpoint"}
maps.n["gz"] = {"<cmd>lua require'dapui'.open()<cr>", desc = "open debug ui"}
maps.n["gZ"] = {"<cmd>lua require'dapui'.close()<cr>", desc = "close debug ui"}
